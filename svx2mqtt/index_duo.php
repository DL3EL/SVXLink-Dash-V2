...
<form method="post">
<fieldset style = "box-shadow:5px 5px 20px #999; background-color:#f1f1f1; height:1165px; margin-top:15px; font-size:13px; border-radius: 10px;">
    ...
    <fieldset style="color:white; background-color:#f1f1f1; height:920; font-size:14px; border:none; border-radius:10px;">
        <form method="post">
                    <section>
                        <h3 style="color:#000000;">Zuletzt Aktiv</h3>
                        <div style="max-height:70vh; overflow:auto;">
                            <fieldset style = "height:920px;box-shadow:2px 2px 10px #999;background-color:#e8e8e8;font-size:12px;border-radius: 10px;">
                            <table id="lhTable">
                                <thead>
                                    <tr style="height:24px;">
                                        <th style="width:22%">&nbsp;&nbsp;Call</th>
