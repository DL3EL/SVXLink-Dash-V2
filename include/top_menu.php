...
<?php
   ...
   if ($_SESSION['auth'] === "AUTHORISED") {
	...
	if (file_exists(DL3EL.'/Reflector1.conf')) {
	    echo '<a href="./edit.php?file=' . DL3EL . '/Reflector1.conf" style = "color: black;" id="reflector1">Reflector1.sh</a> | ';
	}
	if (file_exists(DL3EL.'/Reflector2.conf')) {
	    echo '<a href="./edit.php?file=' . DL3EL . '/Reflector2.conf" style = "color: black;" id="reflector1">Reflector2.sh</a> | ';
	}
	if (file_exists(DL3EL.'/Reflector3.conf')) {
	    echo '<a href="./edit.php?file=' . DL3EL . '/Reflector3.conf" style = "color: black;" id="reflector1">Reflector3.sh</a> | ';
	}
	if (file_exists(DL3EL.'/Reflector4.conf')) {
	    echo '<a href="./edit.php?file=' . DL3EL . '/Reflector4.conf" style = "color: black;" id="reflector1">Reflector4.sh</a> | ';
	}
	echo '</p>';
}
