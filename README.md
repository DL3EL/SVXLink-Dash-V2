...
<p><b>MonitorCalls</b> shows all calls which are monitoring the TGs you have selected as monitoring or active TGs. Additionally it shows at the top who is currently talking (if any, at the time of this call) and below the list aof active TGS enhanced by the number of active users. A click joines the selected TG locally.</p>
...
<p><b>SoundCard:</b>if you are unable to configure the system with *only* one soundcard for svxlink, the index to the card could be different after a reboot <br>
